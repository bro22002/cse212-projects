...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The queue is behaving like a stack (LIFO) instead of a queue (FIFO). The first person dequeued was supposed to be Sue instead of Bob.
    ...
    // Defect(s) Found: The queue is behaving like a stack (LIFO) instead of a queue (FIFO).
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with infinite turns are not added back to the queue.
    ...
    // Defect(s) Found: People with infinite turns that is are not added back to the queue.
    ...
    // Defect(s) Found: No defects found, test should pass.
